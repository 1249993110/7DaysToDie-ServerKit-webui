    ...
    <div>
        ...
        >
            <template #columns>
                ...
                <el-table-column prop="nameColor" :label="t('views.coloredChat.tableHeader.nameColor')" sortable> </el-table-column>
                <el-table-column prop="textColor" :label="t('views.coloredChat.tableHeader.textColor')" sortable> </el-table-column>
